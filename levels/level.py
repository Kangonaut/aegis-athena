...
Now, the trick is to remember how to activate it. I scrunch up my nose, trying to recall the command. The endless days in training flash in my mind, trying to grasp that one piece of life-saving information. `transmit 1d40 <MESSAGE>` ... That's it! I let out a small chuckle, surprised by the sudden clarity.
